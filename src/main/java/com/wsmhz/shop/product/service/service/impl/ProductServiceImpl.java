package com.wsmhz.shop.product.service.service.impl;
...
import com.wsmhz.shop.product.service.mapper.ProductMapper;
...
//            criteria.andEqualTo("categoryId",categoryId);
    ...
    @Override
    public int selectStockByProductId(Long id) {
        return productMapper.selectStockByProductId(id);
    }

    @Override
    public ProductSimpleVo selectById(Long id) {
        Product product = productMapper.selectByPrimaryKey(id);
        return DozerBeanUtil.map(product, ProductSimpleVo.class);
    }

    @Override
    public int updateByPrimaryKeySelective(ProductUpdateForm productUpdateForm) {
        Product product =  DozerBeanUtil.map(productUpdateForm, Product.class);
        product.setStatus(ProductConst.StatusEnum.getItem(productUpdateForm.getStatus()));
        product.setFlag(ProductConst.FlagEnum.getItem(productUpdateForm.getFlag()));
